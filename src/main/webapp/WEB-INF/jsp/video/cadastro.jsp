...
<body>
	...
	<div class="container mt-3">
		<form action="/videos/incluir" method="post" style="display: flex; flex-direction: column;">
			<c:import url="/WEB-INF/jsp/conteudo/cadastro.jsp"></c:import>
			<div class="mb-3 mt-3">
				<label for="videoUrl">Link do vídeo:</label> 
				<input type="text" class="form-control" placeholder="Link do vídeo" name="videoUrl">
			</div>
